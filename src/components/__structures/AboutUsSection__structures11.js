...
export default function AboutUsSection__structures11() {
  ...
  <div>
          ...
          <div className="relative flex items-center justify-between">
            <div className="w-auto">
              <a className="inline-block" href="#">
                <img src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/noBgColor-png-1752174701211.webp" alt />
              </a>
            </div>
    ...
    <section className="relative py-32">
      <img className="absolute top-0 left-0 h-full w-full object-cover" src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/about-us.jpg" alt />
      <div className="absolute top-0 left-0 h-full w-1/2 bg-gradient-shadow-left" />
      <div className="relative container px-4 mx-auto">
        <div className="max-w-md sm:max-w-xl mx-auto md:mx-0">
          <h1 className="font-heading text-3xl sm:text-4xl text-white mb-6">Pioneers in Image-based Short-term Predictive Risk Assessment</h1>
          <p className="text-lg leading-8 text-white mb-10">We are redefining imaging intelligence and innovating healthcare insight.</p>
