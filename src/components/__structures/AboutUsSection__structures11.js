...
export default function AboutUsSection__structures11() {
  ...
  <div><section className="py-16 bg-green-500 bg-contain bg-no-repeat bg-center" style={{backgroundImage: 'url("acros-assets/images/call-to-action/cta-1-bg.png")'}}>
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="font-heading text-3xl sm:text-4xl text-white mt-2 mb-6">About medara™</h1>
