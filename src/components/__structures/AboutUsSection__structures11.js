...
export default function AboutUsSection__structures11() {
    return (
        <React.Fragment>
            <>
                <div>
  <section className="bs-section-dragged pb-0">
        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="w-auto lg:hidden">
            <button className="inline-flex w-14 h-14 justify-center items-center bg-gray-500 hover:bg-gray-600 rounded-full">
              <svg id="svg_a7e18ab793d13f43cd3360cc2968f730" width={20} height={10} viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg" />
            </button>
          </div>
        </div>
      </div>
    ...
    <div className="relative h-140 w-full"><a className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 group flex items-center justify-center w-24 h-24 rounded-full overflow-hidden" href="#" /></div>
  ...
  <div>
    <section className="pb-12 lg:pb-32">
      <div className="mb-40 md:mb-12 py-18 bg-cover bg-no-repeat bg-center" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/photo-1658913005434-837a0c771f1b-1752174927064-webp-1752677900240.webp")'}}>
        <div className="relative container px-4 mx-auto">
          <div className="w-full xl:w-1/2 px-4 mb-24 xl:mb-0">
            <div className="max-w-md md:max-w-lg mx-auto">
              ...
              <h1 className="font-heading text-4xl md:text-5xl text-white mb-6">AI-powered Predictive Risk Assessment</h1>
              <p className="text-lg leading-8 text-white mb-10">Take care to develop resources continually and integrity them with previous projects.</p>
              <div className="sm:flex items-center">
                <a className="inline-block w-full sm:w-auto py-4 px-6 mb-4 sm:mb-0 sm:mr-4 text-center font-heading font-medium text-base text-white bg-green-500 hover:bg-green-600 border border-green-500 hover:border-green-600 border border-green-500 hover:border-green-600 rounded-sm transition duration-200" href="#">Track your performance</a><a className="inline-block w-full sm:w-auto py-4 px-6 text-center font-heading font-medium text-base text-white hover:text-green-500 border border-white hover:border-green-500 rounded-sm transition duration-150" href="#">Learn more</a>
              </div>
            </div>
          </div>
          <img className="xl:absolute top-0 right-0 block mx-auto -mb-52 xl:-mb-0" src="acros-assets/images/headers/header-1-woman.png" alt />
        </div>
      </div>
      <div className="relative container px-4 mx-auto">
