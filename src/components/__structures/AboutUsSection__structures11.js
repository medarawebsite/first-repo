...
export default function AboutUsSection__structures11() {
  ...
  <div>
    <section className="pb-12 lg:pb-32">
          ...
          <div className="relative flex items-center justify-between">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden lg:block">
              <ul className="flex items-center">
                <li className="font-heading mr-12"><a className="hover:text-black" href="#">About</a></li>
                <li className="font-heading mr-12"><a className="hover:text-black" href="#">Company</a></li>
                <li className="font-heading mr-12"><a className="hover:text-black" href="#">Services</a></li>
                <li className="font-heading mr-12"><a className="hover:text-black" href="#">Testimonials</a></li>
              </ul>
            </div>
      ...
      <div className="mb-40 md:mb-12 py-18 bg-cover bg-no-repeat bg-center" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/blue-gradiant.png")'}}>
        <div className="relative container px-4 mx-auto">
          <div className="w-full xl:w-1/2 px-4 mb-24 xl:mb-0">
            <div className="max-w-md md:max-w-lg mx-auto">
              ...
              <h1 className="font-heading text-4xl md:text-5xl text-white mb-6">Pioneers in Image-based Short-term  Predictive Risk Assessment</h1>
          ...
          <img className="xl:absolute top-0 right-0 block mx-auto -mb-52 xl:-mb-0" src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/about-us-image-png-1753123963755.webp" alt />
        </div>
      </div>
  ...
  <section className="py-16 bg-green-500 bg-contain bg-no-repeat bg-center" style={{background: '50% 50% / contain no-repeat scroll padding-box border-box #004aac'}}>
    <div className="container px-4 mx-auto">
      <div className="max-w-3xl mx-auto text-center">
        <h1 className="font-heading text-3xl sm:text-4xl text-white mt-2 mb-6">Vision Statement</h1>
        <p className="max-w-2xl mx-auto text-lg leading-8 text-white mb-12">Empowering clinicians and patients with personalized breast cancer risk insights utilizing breakthrough AI imaging technology.</p>
