...
export default function AboutUsSection__structures11() {
    return (
        <React.Fragment>
            <>
        ...
        <div className="relative flex items-center justify-between">
          <div className="w-auto">
            <a className="inline-block" href="#">
              <img src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/noBgColor-png-1752167288654.webp" alt />
            </a>
          </div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden lg:block">
            <ul className="flex items-center">
              <li className="font-heading mr-12 text-base"><a className="hover:text-black" href="#">About</a></li>
  ...
  <div className="flex flex-wrap -mx-4 -mb-4 md:mb-0">
      ...
      <section className="py-16 bg-white bg-contain bg-no-repeat bg-center" style={{backgroundImage: 'url("acros-assets/images/call-to-action/cta-2-bg.png")'}}>
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <span className="text-sm font-semibold uppercase">Our Company</span>
            <h1 className="font-heading text-3xl sm:text-4xl mt-2 mb-6">Mission</h1>
            <p className="max-w-2xl mx-auto text-lg leading-8 mb-12">Our mission is to harnes the power of AI to deliver personalized, imaging-based risk assessments that enable earlier intervention, informed clinical decisions, and better outcomes for every patient.</p>
    ...
    <div className="w-full md:w-1/2 px-4 mb-4 md:mb-0">
      <section className="py-16 bg-white bg-contain bg-no-repeat bg-center" style={{backgroundImage: 'url("acros-assets/images/call-to-action/cta-2-bg.png")'}}>
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <span className="text-sm font-semibold uppercase">Our Organizational</span>
            <h1 className="font-heading text-3xl sm:text-4xl mt-2 mb-6">Vision</h1>
            <p className="max-w-2xl mx-auto text-lg leading-8 mb-12">Empowering clinicians and patients with personalized breast cancer risk insights utilizing breakthrough AI imaging technology for earlier, more informed decisions</p>
            <div className="sm:flex items-center justify-center">
            </div>
          </div>
        </div>
