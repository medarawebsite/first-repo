          ...
          <div className="w-full xl:w-1/2 px-4 mb-24 xl:mb-0">
            <div className="max-w-md md:max-w-lg mx-auto">
              ...
              <div className="sm:flex items-center">
                <a className="inline-block w-full sm:w-auto py-4 px-6 mb-4 sm:mb-0 sm:mr-4 text-center font-heading font-medium text-base text-white bg-green-500 hover:bg-green-600 border border-green-500 hover:border-green-600 border border-green-500 hover:border-green-600 rounded-sm transition duration-200" href="#">Mission</a><a className="inline-block w-full sm:w-auto py-4 px-6 text-center font-heading font-medium text-base text-white hover:text-green-500 border border-white hover:border-green-500 rounded-sm transition duration-150" href="#">Leadership</a>
              </div>
            </div>
          </div>
          <img className="xl:absolute top-0 right-0 block mx-auto -mb-52 xl:-mb-0" src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/about-us-image-png-1753118939907.webp" alt />
        </div>
      </div>
      <div className="relative container px-4 mx-auto">
