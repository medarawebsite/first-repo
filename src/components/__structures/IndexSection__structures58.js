...
export default function IndexSection__structures58() {
    ...
    <section>
      <nav className="py-4 bg-white">
        <div className="container mx-auto px-4">
          <div className="relative flex items-center justify-between">
            ...
            <div className="w-auto hidden lg:block"><a className="inline-block py-4 px-8 font-heading font-medium text-base text-white bg-green-500 hover:bg-green-600 border border-green-500 hover:border-green-600 rounded-sm transition duration-200" href="/contactus">Contact</a></div>
      ...
      <div className="pt-24 sm:pt-34 pb-8 bg-cover" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/photo-1588421357574-87938a86fa28-1753900689623.webp")'}}>
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl xl:max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-heading text-4xl md:text-5xl text-white mb-6">A New Era in Risk Prediction</h1>
            <div className="sm:flex items-center justify-center mb-24"><a className="inline-block w-full sm:w-auto py-4 px-6 mb-4 sm:mb-0 sm:mr-4 text-center font-heading font-medium text-base text-gray-900 bg-white hover:bg-green-600 border border-green-500 hover:border-green-600 rounded-sm transition duration-200" href="#">Keep Scrolling</a></div>
    ...
    <section className="py-16 bg-white">
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap items-center -mx-4 mb-16">
          ...
          <div className="w-full xl:w-auto ml-auto px-4 xl:text-right"><a className="inline-block w-full sm:w-auto py-4 px-6 text-center font-heading font-medium text-base text-gray-900 hover-custom-blue border border-gray-900 rounded-sm transition duration-150" href="/technology">Get More Details</a></div>
        </div>
        <div className="flex flex-wrap -mx-4">
          <div className="w-full sm:w-1/2 xl:w-1/4 px-4 mb-12 xl:mb-0">
            <div className="max-w-xs mx-auto">
              <div className="flex items-center justify-center w-16 h-16 mb-8 bg-white rounded">
                <img src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/BW-actionable.svg" alt="Icon" />
              </div>
          ...
          <div className="w-full sm:w-1/2 xl:w-1/4 px-4 mb-12 xl:mb-0">
            <div className="max-w-xs mx-auto">
              <div className="flex items-center justify-center w-16 h-16 mb-8 bg-white rounded">
                <img src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/BW-time-icon.svg" alt="Icon" />
              </div>
          ...
          <div className="w-full sm:w-1/2 xl:w-1/4 px-4 mb-12 sm:mb-0">
            <div className="max-w-xs mx-auto">
              <div className="flex items-center justify-center w-16 h-16 mb-8 bg-white rounded">
                <img src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/BW-Costs.svg" alt="Icon" />
              </div>
          ...
          <div className="w-full sm:w-1/2 xl:w-1/4 px-4">
            <div className="max-w-xs mx-auto">
              <div className="flex items-center justify-center w-16 h-16 mb-8 bg-white rounded">
                <img src="https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/BW-patient-outcomes.svg" alt="Icon" />
              </div>
