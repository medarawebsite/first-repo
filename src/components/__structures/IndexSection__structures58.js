      ...
      <div className="pt-24 sm:pt-34 pb-8 bg-cover" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/photo-1587664289285-e6fb47cbe370-1752163934279-webp-1752167764826.webp")'}}>
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl xl:max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-heading text-4xl md:text-5xl text-white mb-6">A New Era in Risk Predictio</h1>
            <div className="sm:flex items-center justify-center mb-24">
              <a className="inline-block w-full sm:w-auto py-4 px-6 mb-4 sm:mb-0 sm:mr-4 text-center font-heading font-medium text-base text-white bg-green-500 hover:bg-green-600 border border-green-500 hover:border-green-600 rounded-sm transition duration-200" href="#">Keep Scrolling</a>
            </div>
