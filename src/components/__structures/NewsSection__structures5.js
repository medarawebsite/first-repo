...
export default function NewsSection__structures5() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container mx-auto"><div>
      <section className="py-16 bg-contain bg-no-repeat bg-center" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/header-news-no-words.png")'}}>
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="font-heading text-3xl sm:text-4xl text-white mt-2 mb-6">Press Room</h1>
