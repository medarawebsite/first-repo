...
export default function AboutUsSectionHeaders3() {
    return (
        <React.Fragment>
            <>
                <section>
  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap -mx-4 pt-10 pb-16 items-end">
      <div className="w-full lg:w-2/3 px-4 mb-12 lg:mb-0">
        <div className="max-w-lg md:max-w-2xl">
          <h1 className="font-heading text-4xl sm:text-5xl mb-10">
            <span>About</span>
            <span className="text-green-500">medara</span>
            <span>every day</span>
          </h1>
          <p className="text-lg leading-8">Vision &amp; Mission</p>
        </div>
      </div>
