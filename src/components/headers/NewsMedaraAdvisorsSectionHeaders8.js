...
export default function NewsMedaraAdvisorsSectionHeaders8() {
    return (
        <React.Fragment>
            <>
                <section className>
  ...
  <div className="pt-24 sm:pt-34 -mb-5 bg-cover" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/photo-1587664289285-e6fb47cbe370-1752163934279-webp-1752167764826.webp")'}}>
