...
export default function NewsMedaraAdvisorsSectionHeaders8() {
  ...
  <div className="pt-24 sm:pt-34 -mb-5 bg-cover" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/photo-1588421357574-87938a86fa28-1753900689623.webp")'}}>
