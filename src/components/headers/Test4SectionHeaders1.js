...
export default function Test4SectionHeaders1() {
    return (
        <React.Fragment>
            <>
                <section>
  ...
  <div className="pt-24 sm:pt-34 pb-8 bg-cover" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/home-blue.png")'}}>
    <div className="container px-4 mx-auto">
      <div className="max-w-2xl xl:max-w-4xl mx-auto text-center">
        ...
        <h1 className="font-heading text-4xl md:text-5xl text-white mb-6">Home page</h1>
