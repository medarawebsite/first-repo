...
export default function Test6SectionHeaders1() {
  ...
  <div className="pt-24 sm:pt-34 pb-8 bg-cover" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/technology-blue.png")'}}>
