...
export default function TestSectionHeaders1() {
    return (
        <React.Fragment>
            <>
                <section>
  ...
  <div className="pt-24 sm:pt-34 pb-8 bg-cover" style={{backgroundImage: 'url("https://static.shuffle.dev/uploads/files/89/891aed3d3e1847e9f17b379d6d326119edf7f96f/background-1.png")'}}>
